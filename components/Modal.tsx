  ...
  return (
    ...
    >
      <>
        ...
        <button
          className="absolute modalButton right-5 top-20 !z-40 
        h-9 w-9 border-none hover:bg-[#181818] "
        >
          <XMarkIcon className="h-7 w-7" onClick={handleClose} />
        </button>

        <button
          className="modalButto absolute modalButton right-5 top-40 !z-40 
        h-9 w-9 border-none md:hidden"
          onClick={handleList}
        >
          {addedToList ? (
        ...
        <div className="relative pt-[56.25%]">
          ...
          <div className="hidden absolute bottom-10 md:flex w-full items-center justify-between px-10 ">
        ...
        <div className="flex space-x-16 rounded-b-md bg-[#181818] px-10 py-8">
          <div className="space-y-3 text-lg md:space-y-6">
            ...
            <div className="flex flex-col gap-x-10 gap-y-4 font-light text-xs md:text-xl md:flex-row">
              <p className="w-8/6 md:w-5/6">{movie?.overview}</p>
              <div className="flex flex-col space-y-3 text-xs md:text-sm">
                <div>
